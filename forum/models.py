...
class Community(models.Model):
    ...
    commUser = models.ForeignKey(User, on_delete=models.CASCADE,
        related_name="forum_communities")
...
class JoinComm(models.Model):
    ...
    JoinCommUser = models.ForeignKey(User, on_delete=models.CASCADE,
        related_name="forum_joined_comms")
    JoinComm = models.ManyToManyField(Community, related_name="forum_comms")
    Joined = models.CharField(max_length=100, null=True, blank=True,
        default='FALSE')
